...
namespace ICD.Connect.Settings.ORM.DapperLite
{
    ...
    public abstract class Database<TId>
    {
        ...
        /// <param name="exceptionHandler">Delegate which will receive any caught Exception objects.</param>
		...
		/// <returns></returns>
	    private string CreateTable(MemberInfo type)
		{
			string tableName = Pluralize(type.Name);
